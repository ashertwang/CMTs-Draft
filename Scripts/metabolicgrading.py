...
Original file is located at
    https://colab.research.google.com/drive/1PSoWkn3zgxOZSa4QZHhjAW8WBtkvGBRW
"""
...
data = pd.read_csv("../Data/mg_unadjmetaboliteprofiling.csv")
features = data.columns[2:]
target_column = 'Tumor Grade'
...
data[target_column] = data[target_column].map({'Grade_1': 1, 'Grade_2': 2, 'Grade_3': 3})
